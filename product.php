                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php $i=1;foreach($products as $product):?>
                          <?php if($product['user_id']===$_SESSION['id_user'] || $product['user_role']==="user"):?>
                        <tr>
                          <td><?php echo $i++?></td>
                          ...
                          <td><img src="<?php echo $product['product_image'];?>"/></td>
                            <td>
                                <a href="editproduct.php?id=<?php echo $product['id_product'];?>" class="badge badge-primary">Edit</a>
                                <a href="deleteproduct.php" class="badge badge-danger">Delete</a>
                                <a href="albumproduct.php" class="badge badge-danger">Album Image</a>
                            </td>
                        </tr>
                        <?php endif;?>
                        <?php endforeach;?>
