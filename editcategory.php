            ...
            <div class="col-md-6 grid-margin stretch-card" style="height: fit-content;">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <?php if(mysqli_num_rows($result)>0): $row=mysqli_fetch_array($result);?>
                            <form class="forms-sample" action="c_updatecategory.php" method="POST">
                                <input type="hidden" value="<?=$row['id_category'];?>" name="id_category">
                                <div class="form-group">
                                <label for="exampleInputName1">Name category</label>
                                <input type="text" name="name" class="form-control" id="exampleInputName1" placeholder="Name category" value="<?php echo $row['name'];?>">
                                </div>
                                <div class="form-group">
                                ...
                                <select class="form-select" aria-label="Default select example" name="parent_id">
                                    ...
                                    <?php else:?>
                                      <option selected value="NULL">select parent category</option>
                                      <?php foreach($categories as $category):?>
                                        <?php if($category['id_category']===$row['parent_id']):?>
                                        <option selected value="<?=$row['parent_id'];?>"><?php echo $category['name']?></option>
                                        <?php foreach($categories as $category):?>
                                        <option value="<?php echo $category['id_category'];?>"><?php echo $category['name'];?></option>
                                        <?php endforeach;?>
                                        <?php endif;?>
