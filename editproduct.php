        ...
        <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <a href="template/https://www.bootstrapdash.com/product/star-admin-pro/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo" target="_blank" class="btn me-2 buy-now-btn border-0">Get Pro</a>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
            <a href="template/https://www.bootstrapdash.com/product/star-admin-pro/"><i class="mdi mdi-home me-3 text-white"></i></a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold"><?=$_SESSION['user_name'].' '.$_SESSION['id_user'];?></span></h1>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="c_logout.php"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
            </div>
          </li>
        </ul>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="addcategory.php">Add Categories</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="template/http://bootstrapdash.com/demo/star-admin2-free/docs/documentation.html">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php if(mysqli_num_rows($result_product)>0): $row_product=mysqli_fetch_array($result_product);?>
                  <form class="form-sample" action="c_updateproduct.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" value="<?php echo $row_product['id_product']?>" name="id_product">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_name" value="<?php echo $row_product['product_name'];?>"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="product_price" value="<?php echo $row_product['product_price'];?>"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-select form-control" name="category_id">
                                <?php foreach($categories as $category):?>
                                  <?php if($category['id_category']===$row_product['category_id']):?>
                                  <option selected value="<?=$row_product['category_id'];?>"><?php echo $category['name']?></option>
                                  <?php foreach($categories as $category):?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="product_quantity" value="<?php echo $row_product['product_quantity'];?>"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="mb-5">
                          ...
                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="product_description"><?php echo $row_product['product_description'];?></textarea>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Created Product</label>
                          <div class="col-sm-9">
                            <input type="date" class="form-control" name="created_at" value="<?php echo $row_product['created_at'];?>"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Update Product</label>
                          <div class="col-sm-9">
                            <input type="date" class="form-control" name="updated_at"  value="<?php echo $row_product['updated_at'];?>"/>
                          </div>
                        </div>
                      </div>
                    </div>
